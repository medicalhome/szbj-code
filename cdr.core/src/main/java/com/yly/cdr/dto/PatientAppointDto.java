...
public class PatientAppointDto {
	...
	public int getAppointmentSn() {
		return appointmentSn;
	}

	public void setAppointmentSn(int appointmentSn) {
		this.appointmentSn = appointmentSn;
	}

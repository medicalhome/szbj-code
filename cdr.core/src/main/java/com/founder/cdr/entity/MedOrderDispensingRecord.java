...
@Entity
@Table(name = "MED_ORDER_DISPENSING_RECORD")
public class MedOrderDispensingRecord implements Serializable
{
    ...
    @Column(name = "DISPENSING_QUANTITY", length = 32)
    ...
    @Column(name = "DISPENSING_UNIT", length = 32)

...
public class Hl7MessageWmq implements TextMessage
{
    /**
     * 消息ID
     */
    ...
    {
        headers.put(EXTEND_SUB_ID, extendSubId);
    }
    ...
    public static String extractHospitalCd(Map<String, String> header)
    {
        ...
        if (header == null)
            ...
            orgCode = header.get(HEADER_HOSPITAL_CD);

        if (orgCode == null || "".equalsIgnoreCase(orgCode))
            orgCode = null;
    ...
    {
        if (Hl7MessageWmq.HEADER_SERVICE_ID.equalsIgnoreCase(name)
                ||Hl7MessageWmq.HEADER_DOMAIN_ID.equalsIgnoreCase(name)
                ||Hl7MessageWmq.HEADER_ORDER_DISPATCH_TYPE.equalsIgnoreCase(name)
                ||Hl7MessageWmq.HEADER_EXEC_UNIT.equalsIgnoreCase(name)
                ||Hl7MessageWmq.HEADER_HOSPITAL_CD.equalsIgnoreCase(name)
                ||Hl7MessageWmq.HEADER_SOURCE_SYS_CD.equalsIgnoreCase(name)
                ||Hl7MessageWmq.ORDER_EXEC_ID.equalsIgnoreCase(name)
                ||Hl7MessageWmq.EXTEND_SUB_ID.equalsIgnoreCase(name)
                ||Hl7MessageWmq.APPLY_UNIT_ID.equalsIgnoreCase(name)
                )
            return true;

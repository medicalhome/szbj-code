...
import com.yly.cdr.entity.CodeSystem;
...
//        }
    ...
    public void setMessageList(MSBaseDto<CodeValueDto> t)
    {
        ...
        for (CodeValueDto codeValueDto : codeValueDtos)
        {
            ...
            // 从DB中找到关联的数据
            com.yly.cdr.dto.CodeValueDto record = getMessageRecordFromDB(
    ...
    private void processUpdateMessage(MSBaseDto<CodeValueDto> t,
            com.yly.cdr.dto.CodeValueDto record, CodeValueDto codeValueDto)
    {
    	/*
    	 * $Author: yu_yzh
...
//		logger.debug("新增或者更新消息时");
     ...
     */
    public com.yly.cdr.dto.CodeValueDto getMessageRecordFromDB(
            String tableName, String code, String foreignKey)
    {
        com.yly.cdr.dto.CodeValueDto codeValue = dictionaryService.selectRecordExistByTableName(

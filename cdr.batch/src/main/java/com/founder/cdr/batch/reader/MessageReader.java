package com.founder.cdr.batch.reader;
...
import com.founder.cdr.batch.exception.database.DatabaseException;
import com.founder.cdr.batch.exception.mail.MailException;
import com.founder.cdr.batch.exception.message.MessageStructureException;
import com.founder.cdr.batch.exception.mq.MQException;
...
import com.founder.cdr.util.mail.MailUtils;
import com.founder.cdr.util.mq.MQClient;
import com.founder.cdr.util.mq.MQSession;
 ...
 * reader中read()方法抛出{@link com.founder.cdr.batch.exception.UnexpectedException}异常：open()->update()->read()->close()
 * reader中read()方法抛出{@link com.founder.cdr.batch.exception.ExpectedException}异常：open()->update()->read()->...read()->执行完指定消息->update()->close()
 * 
 * processor中process()方法抛出{@link com.founder.cdr.batch.exception.UnexpectedException}异常：open()->update()->read()->process()->close()
 * 
 * writer中write()方法抛出{@link com.founder.cdr.batch.exception.UnexpectedException}异常：open()->update()->read()->process()->write()->close()
 * 
 * @author wen_ruichao
 * @version 1.0
 */

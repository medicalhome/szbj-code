...
import com.founder.cdr.hl7.dto.MedicationMessage;
import com.founder.cdr.hl7.dto.PhysicalExaminationItem;
import com.founder.cdr.hl7.dto.TimeQuantum;
import com.founder.cdr.hl7.dto.TransfuseMessage;
import com.founder.cdr.hl7.dto.pocdhd000040uv01.POCDHD000040UV01;
import com.founder.cdr.hl7.dto.pocdhd000040uv01.ReviewPersonDto;
...
/*        if (!(isDeleteMessage(pocdhd000040uv01)))
    ...
    public List<Object> getDiagnosisMessage(POCDHD000040UV01 pocdhd000040uv01)
    {
        ...
        List<com.founder.cdr.hl7.dto.Diagnosis> mainDiagnosisList = pocdhd000040uv01.getDiagnosis();
        // 循环取出消息中的主诊断

...
import com.founder.cdr.hl7.dto.fiabin020001uv01.FIABIN020001UV01;
...
public class FIABIN020001UV01Writer implements BusinessWriter<FIABIN020001UV01>
{
    ...
    public boolean validate(FIABIN020001UV01 fiabin020001uv01)
    {
        ...
        if (Constants.PATIENT_DOMAIN_OUTPATIENT.equals(fiabin020001uv01.getPatientDomain()))
        {
            ...
            for (com.founder.cdr.hl7.dto.BillingReceipt billingReceipt : fiabin020001uv01.getBillingReceipt())
            {
                for (com.founder.cdr.hl7.dto.BillingItem billingItem : billingReceipt.getBillingItem())
                {
            ...
            /*
             * List<com.founder.cdr.hl7.dto.BillingReceipt> billingReceiptList =
             * fiabin020001uv01.getBillingReceipt();
             * List<com.founder.cdr.hl7.dto.BillingItem> billingItemList = null;
             * for (com.founder.cdr.hl7.dto.BillingReceipt billingReceipt :
             * billingReceiptList) { billingItemList =
             * billingReceipt.getBillingItem(); for
             * (com.founder.cdr.hl7.dto.BillingItem billingItem :
            ...
            FIABIN020001UV01 fiabin020001uv01)
    {
        ...
        {
            // 获取帐单信息
            List<com.founder.cdr.hl7.dto.BillingReceipt> billingReceiptDtoList = fiabin020001uv01.getBillingReceipt();

            if (billingReceiptDtoList != null)
            {
                // 遍历消息中的所有帐单信息
                for (com.founder.cdr.hl7.dto.BillingReceipt billingReceiptDto : billingReceiptDtoList)
                {
                    // $Author :jia_yanqing
    ...
    public List<BillingItem> getBillingItem(
            com.founder.cdr.hl7.dto.BillingReceipt billingReceiptDto,
            BigDecimal receiptSn, String insurancePaid, String ownExpense)
    // [BUG]0006804 ADD END
    {
        // 获取从消息中传来的明细信息列表
        List<com.founder.cdr.hl7.dto.BillingItem> billingItemDtoList = billingReceiptDto.getBillingItem();
        if (billingItemDtoList != null)
        {
            // 遍历从消息中传来的明细信息列表将其放入billingItemEntityList中
            for (com.founder.cdr.hl7.dto.BillingItem billingItemDto : billingItemDtoList)
            {
                if (Constants.PATIENT_DOMAIN_OUTPATIENT.equals(patientDomain))
                {

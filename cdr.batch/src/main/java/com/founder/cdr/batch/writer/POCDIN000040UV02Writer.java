...
import com.founder.cdr.hl7.dto.ExamItemMessage;
import com.founder.cdr.hl7.dto.ExaminationItems;
import com.founder.cdr.hl7.dto.LabImageContent;
import com.founder.cdr.hl7.dto.SubExamItemMessage;
import com.founder.cdr.hl7.dto.pocdin000040uv02.AssistantMessage;
import com.founder.cdr.hl7.dto.pocdin000040uv02.ExaminingDoctor;
import com.founder.cdr.hl7.dto.pocdin000040uv02.OperatorMessage;
import com.founder.cdr.hl7.dto.pocdin000040uv02.POCDIN000040UV02;
import com.founder.cdr.hl7.dto.pocdin000040uv02.ReviewDoctor;
...
//	private static final String MEDICAL_IMAGE_CLOSE= "0";
	 ...
	 * 就诊消息映射数据 List<com.founder.cdr.hl7.dto.MedicalVisit> medicalVisit =
	...
	private List<Object> getExamResult(POCDIN000040UV02 pocdin000040uv02,
		...
		// 报告内容
		List<com.founder.cdr.hl7.dto.ExaminationResult> reports = pocdin000040uv02
				.getReports();
		for (com.founder.cdr.hl7.dto.ExaminationResult examReport : reports) {
			if (Constants.VERSION_NUMBER_UPDATE.equals(pocdin000040uv02
					.getVersionNo())) {
				// 检查报告更新场合

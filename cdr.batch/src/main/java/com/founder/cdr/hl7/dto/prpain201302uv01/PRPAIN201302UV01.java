package com.founder.cdr.hl7.dto.prpain201302uv01;

import java.util.List;

import org.hibernate.validator.constraints.NotEmpty;

import com.founder.cdr.batch.writer.prpain201302uv01.PRPAIN201302UV01CommonDto;
...
public class PRPAIN201302UV01 extends PRPAIN201302UV01CommonDto
{
    /**
     * 时间戳（版本标识）
     */
    @NotEmpty(message = "{PRPAIN201302UV01.timestamp}")
    private String timestamp;

    /**
     * 患者EMPI标识
     */
    @NotEmpty(message = "{PRPAIN201302UV01.patientEid}")
     ...
     * 患者姓名
     */
    @NotEmpty(message = "{PRPAIN201302UV01.patientName}")
    private String patientName;

    /**
     * 性别代码
     */
    @NotEmpty(message = "{PRPAIN201302UV01.genderCode}")
    private String genderCode;

    /**
     * 出生日期
     */
    @NotEmpty(message = "{PRPAIN201302UV01.birthDate}")

...
<link type="text/css" rel="Stylesheet" href="../styles/jquery-ui-1.8.18.custom.modify.css"
    ...
    <script type="text/javascript" src="../scripts/ProSlide.modify.js"></script>
	...
	<script type="text/javascript" src="../scripts/timerInpatient/excanvas.min.js"></script>
	<script type="text/javascript" src="../scripts/timerInpatient/jquery.flot.others.js"></script>
	<script type="text/javascript" src="../scripts/timerInpatient/jquery.flot.pie.js"></script>
	<script type="text/javascript" src="../scripts/timerInpatient/jquery.flot.stack.js"></script>
...
<body style="margin: 0; padding: 0;">
	...
	<form id="conditionForm" name="conditionForm" method="post"
		action="../portalOrder/duty_${patientSn}.html"
		...
		<table class="blockTable" cellpadding="2" cellspacing="1" border="1px"
			...
			<tr class="conditionRow">
				...
				<!-- $Author :liu_hongjie
					 ...
					 [BUG]0047662 MODIFY BEGIN -->
				<input type="hidden" id="visitTimes" name ="visitTimes" value ="${drugListSearchPra.visitTimes }"/>
		    	...
		    	<input type="hidden" id="patientDomain" name ="patientDomain" value ="${patientCrossIndex.patientDomain }"/>
					<!-- [BUG]0047662 MODIFY END -->
					<div class="cell" style="width: 200px;">
						<div class="cell" style="width: 65px; text-align: right;">药物通用名</div>
					...
					<!-- $Author :liu_hongjie
					 ...
					 [BUG]0047823 MODIFY BEGIN -->					
					<div class="cell" style="width: 270px;">
					<!-- [BUG]0047823 MODIFY END -->
				...
				<!-- [BUG] [BUG]0047660  MODIFY END -->
					...
					<div class="cell" style="width: 160px;">
						...
						<input type="button" style="color: #464646; border: 0px; width: 57px; height: 24px; margin-top: 3px; cursor: pointer;"
						...
						<!-- $Author :liu_hongjie
					       ...
					       [BUG]0047658 MODIFY BEGIN -->
								<input type="button"
								style="color: #464646; border: 0px; BACKGROUND-IMAGE: url(../images/17.png); width: 70px; height: 25px; margin-top: 3px; cursor: pointer;"
							...
							<input type="hidden" name="type" value="${drugListSearchPra.type}" /> 
							<input type="hidden" name="visitSn" value="${drugListSearchPra.visitSn}" />
							<input type="hidden" name="inpatientDate" value="${drugListSearchPra.inpatientDate}" />
						    <!-- $Author :jin_peng
			...
			<tr id='tr2' class="conditionRow moreCondition off">
				<td width="100%" height="36" align="left" valign="middle"> -->
					...
					<div class="cell" style="width: 205px;">
						<div class="cell" style="width: 65px; text-align: right;">长期或临时</div>
						<div class="cell" style="width: 120px;">
			...
			<tr class="tabletitle">
			<td height="28" align="center" width="9%">就诊类型</td>
			<td height="28" align="center" width="12%">药物商品名</td>
			<td height="28" align="center" width="10%">药物类型</td>
			...
			<td height="28" align="center" width="12%">医嘱录入时间</td>
	...
	<table id="tblid" style="width: 100%;" cellspacing="1" cellpadding="2"
		...
		<c:forEach items="${drugList}" var="drugList" varStatus="status">
			...
			<tr id="${drugList.orderSn}"
				...
				<c:if test="${drugListSearchPra.visitSn != null}">onclick="showDialog('../portalOrder/detail_${drugList.orderSn}.html?flag=tabs','药物医嘱',{},700,500,'#ajaxDialogDetail');"</c:if>
				onclick="bigShow($(this),'../portalOrder/detail_${drugList.orderSn}.html?flag=tabs',
						{'otherName':'<c:choose>
				...
				<c:if test="${drugList.patientDomain=='01' }">
					<td height="24" width="9%" align="left" >门诊</td> 
				</c:if>
				<c:if test="${drugList.patientDomain=='02' }"> 
					<td height="24" width="9%" align="left" >住院</td>
				</c:if>
					<td height="24" width="12% align="left" style="display:none">
					药物医嘱|../portalOrder/detail_${drugList.orderSn}.html|  <c:choose>
			...
			<!-- $[BUG]0033461 MODIFY END -->
				...
				<td height="24" width="8%" align="left"
				...
				<td height="24" width="6%" align="left">${drugList.dosage}
					${drugList.dosageUnit}</td>
				<td height="24" width="6%" align="left">${drugList.totalDosage}
				...
				<td height="24"  width="6%" align="left">${drugList.orderPersonName}</td>
				<td height="24" width="12%" align="center"><fmt:formatDate
						value="${drugList.orderTime}" type="date" pattern="yyyy-MM-dd HH:mm" /></td>
				<td height="24" width="10%" align="left">${drugList.orderDeptName}</td>

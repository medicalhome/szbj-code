...
<body style="margin: 0; padding: 0;">
	<c:forEach items="${specificallyDocumentList}" var="specificallyDocumentList"
		varStatus="status">
		<div
			<c:choose>
			...
			<table style="width: 100%; color: blue; cursor: pointer;"
				...
				onclick="loadCommonPanel('病历文书列表',{'url':'../doc/detail_${specificallyDocumentList.documentSn}.html',
						'tabsFlag':'true','gotoType':'doc','special':'special','width':'70%','patientSn':'${patientSn}','documentLid':'${specificallyDocumentList.documentLid}','trID':'${specificallyDocumentList.documentLid}',
						'type':'${TimerAndInpatientDto.DOCUMENTATION}','visitSn':'${visitSn}','name':'${specificallyDocumentList.documentName}',
						'inpatientDate':'${inpatientDate}'});">
				<tr>
					<td style="float: left; width: 30%; border-top: 0; border-bottom: 0; border-left: 0; border-right: 0;">
					 	${specificallyDocumentList.documentTypeName}&nbsp;
					</td>
					<td style="float: left; width: 60%; border-top: 0; border-bottom: 0; border-left: 0; border-right: 0;">
						${specificallyDocumentList.documentName}&nbsp;
					</td>
					<td style="float: left; width: 9%; border-top: 0; border-bottom: 0; border-left: 0; border-right: 0;">
						${specificallyDocumentList.documentAuthorName}&nbsp;
					</td>
				</tr>
			</table>
		</div>

...
<!-- 			<tr style="height:0">
			...
			<tr class="conditionRow">
				<td width="100%" colspan="11" height="30" align="left" valign="middle">
					...
					<div class="cell" style="width: 200px; text-align: right;">
						<input type="text" name="roleName" style="width: 98%;" onmouseover="this.style.background='#FDE8FE';"
			...
			<tr class="conditionRow">
				<td width="100%" colspan="11" align="left" valign="middle">
					...
					<div class="cell" style="width: 200px; text-align: right; height: 80px;">
				...
				<td width="100%" colspan="11" height="36" align="left" valign="middle">
					...
					<div style="width:100px; " class="cell" > 
						<input type="button"
							...
							align="middle" value="搜索" onclick="search('../role/editRoleInfoAndUsers.html', 'conditionForm');" />
					</div>
					<div style="width:100px; " class="cell" > 
						<input type="button"
							style="color: #464646; border: 0px; width: 100px; height: 25px; margin-top: 3px;cursor: pointer;"
							align="middle" value="保存角色信息" onclick="save();" />
					</div>		
					<div style="width:100px; " class="cell" > 
						<input type="button"
							style="color: #464646; border: 0px; width: 100px; height: 25px; margin-top: 3px;cursor: pointer;"
							align="middle" value="添加人员" onclick="showDialog('../role/addUsersPage.html', '添加人员', {'roleId' : ${role.systemRoleId}}, 800, 450);" />
					</div>	
					<div style="width:100px; " class="cell" > 
						<input type="button"
							style="color: #464646; border: 0px; width: 100px; height: 25px; margin-top: 3px;cursor: pointer;"
		...
		<table class="blockTable" cellpadding="2" cellspacing="1" border="0">
			<tr class="tabletitle">
				<td height="28" align="center" width="4%" >
					<input type="checkbox" id="userTop" name="userTop"  value="${role.systemRoleId}" onfocus="this.blur()" onclick="userTop(this);" />
				</td>
		...
		<table id="tblid" style="width: 100%;" cellspacing="1" cellpadding="2" class="table">
			...
			<c:if test="${fn:length(userList)!=0}">
				<c:forEach items="${userList}" var="user" varStatus="status">
					<tr id="${user.userId}" style="cursor:pointer" class="tabEnter">
			...
			<tr class="page_line">
				<td colspan="11" style="height: 27px;">
					<form name="pagingform" method="get" action="../role/editRoleInfoAndUsers.html">
						<div class="pagelinks">

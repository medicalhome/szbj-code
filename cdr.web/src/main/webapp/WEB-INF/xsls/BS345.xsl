			...
			<body>
				<div id="mainContent">
					<div name="selectTabs">
						...
						<table border="0" align="center" width="100%" cellspacing="1" cellpadding="2" style="border-collapse:collapse;bgcolor:white;">
							<tr>
							...
							<!-- 	
								<td class="doclabel">与患者关系：</td>
								<td class="docdataitem"><xsl:value-of select="sc:informant/sc:assignedEntity/sc:code/@displayName"/></td>
								-->
								...
								<td class="docdataitem"><xsl:choose>
									<xsl:when test="string-length(sc:component/sc:structuredBody/sc:component[sc:section/sc:entry/sc:observation/sc:code/@code='DE02.01.036.00']/sc:section/sc:entry[sc:observation/sc:code/@code='DE02.01.036.00']/sc:observation/sc:effectiveTime/sc:high/@value)>8">
										<xsl:value-of select="substring(sc:component/sc:structuredBody/sc:component[sc:section/sc:entry/sc:observation/sc:code/@code='DE02.01.036.00']/sc:section/sc:entry[sc:observation/sc:code/@code='DE02.01.036.00']/sc:observation/sc:effectiveTime/sc:high/@value,1,4)"/>年<xsl:value-of select="substring(sc:component/sc:structuredBody/sc:component[sc:section/sc:entry/sc:observation/sc:code/@code='DE02.01.036.00']/sc:section/sc:entry[sc:observation/sc:code/@code='DE02.01.036.00']/sc:observation/sc:effectiveTime/sc:high/@value,5,2)"/>月<xsl:value-of select="substring(sc:component/sc:structuredBody/sc:component[sc:section/sc:entry/sc:observation/sc:code/@code='DE02.01.036.00']/sc:section/sc:entry[sc:observation/sc:code/@code='DE02.01.036.00']/sc:observation/sc:effectiveTime/sc:high/@value,7,2)"/>日<xsl:value-of select="substring(sc:component/sc:structuredBody/sc:component[sc:section/sc:entry/sc:observation/sc:code/@code='DE02.01.036.00']/sc:section/sc:entry[sc:observation/sc:code/@code='DE02.01.036.00']/sc:observation/sc:effectiveTime/sc:high/@value,9,2)"/>时<xsl:value-of select="substring(sc:component/sc:structuredBody/sc:component[sc:section/sc:entry/sc:observation/sc:code/@code='DE02.01.036.00']/sc:section/sc:entry[sc:observation/sc:code/@code='DE02.01.036.00']/sc:observation/sc:effectiveTime/sc:high/@value,11,2)"/>分
									</xsl:when>
									<xsl:when test="string-length(sc:component/sc:structuredBody/sc:component[sc:section/sc:entry/sc:observation/sc:code/@code='DE02.01.036.00']/sc:section/sc:entry[sc:observation/sc:code/@code='DE02.01.036.00']/sc:observation/sc:effectiveTime/sc:high/@value)>0">
										<xsl:value-of select="substring(sc:component/sc:structuredBody/sc:component[sc:section/sc:entry/sc:observation/sc:code/@code='DE02.01.036.00']/sc:section/sc:entry[sc:observation/sc:code/@code='DE02.01.036.00']/sc:observation/sc:effectiveTime/sc:high/@value,1,4)"/>年<xsl:value-of select="substring(sc:component/sc:structuredBody/sc:component[sc:section/sc:entry/sc:observation/sc:code/@code='DE02.01.036.00']/sc:section/sc:entry[sc:observation/sc:code/@code='DE02.01.036.00']/sc:observation/sc:effectiveTime/sc:high/@value,5,2)"/>月<xsl:value-of select="substring(sc:component/sc:structuredBody/sc:component[sc:section/sc:entry/sc:observation/sc:code/@code='DE02.01.036.00']/sc:section/sc:entry[sc:observation/sc:code/@code='DE02.01.036.00']/sc:observation/sc:effectiveTime/sc:high/@value,7,2)"/>日
									</xsl:when>
								</xsl:choose></td>
							</tr>
							<tr>
							...
							<tr>
								<td class="doclabel">死亡原因：</td>
								<td class="docdataitem" colspan="5"><xsl:value-of select="sc:component/sc:structuredBody/sc:component[sc:section/sc:entry/sc:observation/sc:code/@code='DE05.10.099.00']/sc:section/sc:entry[sc:observation/sc:code/@code='DE05.10.099.00']/sc:observation/sc:value"/></td>
							</tr>
							...
							<tr>
								...
								<td class="docdataitem"><xsl:value-of select="sc:component/sc:structuredBody/sc:component/sc:section/sc:entry/sc:observation[sc:code/@code='417662000']/sc:entryRelationship/sc:observation/sc:code[@codeSystem='1.2.156.112606.1.1.18']/@displayName"/></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="docdataitem"><xsl:value-of select="sc:component/sc:structuredBody/sc:component/sc:section/sc:entry/sc:observation[sc:code/@code='439848005']/sc:performer/sc:assignedEntity/sc:assignedPerson/sc:name"/></td>
								
								
								
								<td class="doclabel">死亡日期：</td>
								<td class="docdataitem"><xsl:choose>
									<xsl:when test="string-length(sc:component/sc:structuredBody/sc:component/sc:section/sc:entry/sc:observation[sc:code/@code='419620001']/sc:effectiveTime/@value)>8">
										<xsl:value-of select="substring(sc:component/sc:structuredBody/sc:component/sc:section/sc:entry/sc:observation[sc:code/@code='419620001']/sc:effectiveTime/@value,1,4)"/>年<xsl:value-of select="substring(sc:component/sc:structuredBody/sc:component/sc:section/sc:entry/sc:observation[sc:code/@code='419620001']/sc:effectiveTime/@value,5,2)"/>月<xsl:value-of select="substring(sc:component/sc:structuredBody/sc:component/sc:section/sc:entry/sc:observation[sc:code/@code='419620001']/sc:effectiveTime/@value,7,2)"/>日<xsl:value-of select="substring(sc:component/sc:structuredBody/sc:component/sc:section/sc:entry/sc:observation[sc:code/@code='419620001']/sc:effectiveTime/@value,9,2)"/>时<xsl:value-of select="substring(sc:component/sc:structuredBody/sc:component/sc:section/sc:entry/sc:observation[sc:code/@code='419620001']/sc:effectiveTime/@value,11,2)"/>分
									</xsl:when>
									<xsl:when test="string-length(sc:component/sc:structuredBody/sc:component/sc:section/sc:entry/sc:observation[sc:code/@code='419620001']/sc:effectiveTime/@value)>0">
										<xsl:value-of select="substring(sc:component/sc:structuredBody/sc:component/sc:section/sc:entry/sc:observation[sc:code/@code='419620001']/sc:effectiveTime/@value,1,4)"/>年<xsl:value-of select="substring(sc:component/sc:structuredBody/sc:component/sc:section/sc:entry/sc:observation[sc:code/@code='419620001']/sc:effectiveTime/@value,5,2)"/>月<xsl:value-of select="substring(sc:component/sc:structuredBody/sc:component/sc:section/sc:entry/sc:observation[sc:code/@code='419620001']/sc:effectiveTime/@value,7,2)"/>日
									</xsl:when>
								</xsl:choose></td>					
							</tr>
							-->
							...
							<tr>
								<td class="doclabel">死亡诊断：</td>
								<td class="docdataitem" colspan="5">
									<xsl:for-each select="sc:component/sc:structuredBody/sc:component/sc:section[sc:code/@code='8648-8']/sc:entry">
							...
							<xsl:for-each select="sc:component/sc:structuredBody/sc:component/sc:section/sc:entry/sc:act/sc:entryRelationship">
								...
								<tr>
									...
									<td colspan="5" class="docdataitem" style="word-break:break-all;word-wrap:break-word;"><pre><xsl:value-of select="sc:observation/sc:text"/></pre></td>
								</tr>
							</xsl:for-each>							
						</table>
						-->

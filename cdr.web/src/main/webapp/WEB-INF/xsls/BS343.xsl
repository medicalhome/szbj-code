				...
				<div id="mainContent">
					<div name="selectTabs">
						...
						<table border="0" align="center" width="100%" cellspacing="1" cellpadding="2" style="border-collapse:collapse;table-layout:fixed;border-bottom: solid 1px #B3C4D4;bgcolor:white;">
							...
							<tr>
								...
								<td  class="docdataitem3" colspan="5">
									<ui style="float:left;list-style-type:decimal;list-style-position:inside">
										<xsl:for-each select="sc:component/sc:structuredBody/sc:component/sc:section/sc:entry[sc:observation/sc:code/@displayName='入院诊断编码']">
											<li><xsl:value-of select="sc:observation[sc:code/@displayName='入院诊断编码']/sc:value/@displayName"/></li>
										</xsl:for-each>
									</ui>
								</td>
							</tr>
							...
							<tr>
							    <td class="doclabel">死亡时间：</td>
								<td class="docdataitem"><xsl:choose>
								<xsl:when test="string-length(sc:component/sc:structuredBody/sc:component/sc:section[sc:code/@displayName='死亡原因章节']/sc:entry/sc:observation[sc:code/@code='DE02.01.036.00']/sc:value/@value)>8">
									<xsl:value-of select="substring(sc:component/sc:structuredBody/sc:component/sc:section[sc:code/@displayName='死亡原因章节']/sc:entry/sc:observation[sc:code/@code='DE02.01.036.00']/sc:value/@value,1,4)"/>年<xsl:value-of select="substring(sc:component/sc:structuredBody/sc:component/sc:section[sc:code/@displayName='死亡原因章节']/sc:entry/sc:observation[sc:code/@code='DE02.01.036.00']/sc:value/@value,5,2)"/>月<xsl:value-of select="substring(sc:component/sc:structuredBody/sc:component/sc:section[sc:code/@displayName='死亡原因章节']/sc:entry/sc:observation[sc:code/@code='DE02.01.036.00']/sc:value/@value,7,2)"/>日<xsl:value-of select="substring(sc:component/sc:structuredBody/sc:component/sc:section[sc:code/@displayName='死亡原因章节']/sc:entry/sc:observation[sc:code/@code='DE02.01.036.00']/sc:value/@value,9,2)"/>时<xsl:value-of select="substring(sc:component/sc:structuredBody/sc:component/sc:section[sc:code/@displayName='死亡原因章节']/sc:entry/sc:observation[sc:code/@code='DE02.01.036.00']/sc:value/@value,11,2)"/>分
								</xsl:when>
								<xsl:when test="string-length(sc:component/sc:structuredBody/sc:component/sc:section[sc:code/@displayName='死亡原因章节']/sc:entry/sc:observation[sc:code/@code='DE02.01.036.00']/sc:value/@value)>0">
								...
								<td class="docdataitem" colspan="3">
									<xsl:value-of select="sc:componentOf/sc:encompassingEncounter/sc:effectiveTime/sc:width/@value"/>
								</td>
							</tr>
							<tr>
								...
								<td class="docdataitem3" colspan="5">
									<ui style="float:left;list-style-type:decimal;list-style-position:inside">
										<xsl:for-each select="sc:component/sc:structuredBody/sc:component/sc:section/sc:entry[sc:observation/sc:code/@displayName='死亡诊断名称']">
											<li><xsl:value-of select="sc:observation[sc:code/@displayName='死亡诊断名称']/sc:value"/></li>
										</xsl:for-each>
									</ui>
								</td>
							</tr>
							<tr>
								...
								<td class="docdataitem3" colspan="5">
									<pre><xsl:value-of select="sc:component/sc:structuredBody/sc:component/sc:section[sc:code/@code='11535-2']/sc:entry/sc:observation[sc:code/@code='DE05.10.148.00' ]/sc:value"/></pre>
								</td>
							</tr>
							<tr>
							    <td class="doclabel" valign="top">住院经过及抢救经过：</td>
								<td class="docdataitem3" colspan="5">
									<pre><xsl:value-of select="sc:component/sc:structuredBody/sc:component/sc:section[sc:code/@code='8648-8' ]/sc:entry/sc:observation/sc:text"/></pre>
								</td>
							</tr>
							<tr>
							    <td class="doclabel" valign="top">死亡原因：</td>
								<td class="docdataitem3" colspan="5">
									<pre><xsl:value-of select="sc:component/sc:structuredBody/sc:component/sc:section[sc:code/@displayName='死亡原因章节']/sc:entry/sc:observation[sc:code/@code='DE05.01.025.00']/sc:value"/></pre>
								</td>
							</tr>
							<tr>
							    <td class="doclabel">病理报告：</td>
								<td class="docdataitem">
									<xsl:value-of select="sc:component/sc:structuredBody/sc:component/sc:section[sc:code/@displayName='关联检查']/sc:entry/sc:observation[sc:code/@displayName='病理报告']/sc:value"/>
								</td>
								
							    <td class="doclabel">X线片号：</td>
								<td class="docdataitem" colspan="3">
									<xsl:value-of select="sc:component/sc:structuredBody/sc:component/sc:section[sc:code/@displayName='关联检查']/sc:entry/sc:observation[sc:code/@displayName='X线片号']/sc:value"/>
								</td>
							</tr>
							<tr>
							    <td class="doclabel">尸体病理解剖情况：</td>
								<td class="docdataitem">
									<xsl:value-of select="sc:component/sc:structuredBody/sc:component/sc:section[sc:code/@displayName='尸检意见章节']/sc:entry/sc:observation/sc:entryRelationship/sc:observation/sc:value"/>
								</td>
							...
							<tr>
								<td class="doclabel">科主任（副主任以上医师）：</td>
								<td class="docdataitem"><xsl:value-of select="sc:authenticator/sc:assignedEntity[sc:code/@displayName='主任医师']/sc:assignedPerson/sc:name"/></td>
								...
								<td class="docdataitem"><xsl:value-of select="sc:authenticator/sc:assignedEntity[sc:code/@displayName='住院医师']/sc:assignedPerson/sc:name"/></td>
							</tr>							
						</table>
					</div>
				</div>
